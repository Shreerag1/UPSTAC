...
public class ConsultationController {
	...
	/**
	 * This method returns the list of test requests having status LAB_TEST_COMPLETED
	...
	/**
	 * This method returns the list of test requests that are
	...
	/**
	 * This method takes id and assigns request to that doctor
	...
	/**
	 * This method takes id and test results and returns the final status
	 * @param id the doctor's ID
	 * @param testResult
	 * @return test request
	 */
